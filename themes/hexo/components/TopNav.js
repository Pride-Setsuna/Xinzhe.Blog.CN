...
const TopNav = props => {
  ...
  return (<div id='top-nav' className='z-40'>
    ...
    {/* 导航栏 */}
    <div id='sticky-nav' className={'top-0 shadow-none fixed bg-none dark:bg-hexo-black-gray dark:text-gray-200 text-black w-full z-50 transform transition-all duration-200 border-transparent dark:border-transparent'}>
